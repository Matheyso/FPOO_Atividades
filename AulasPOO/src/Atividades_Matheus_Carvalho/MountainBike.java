...
public class MountainBike implements Veiculo{
	...
	public void estadoMountainBike() {
		boolean andando;
		if(andando = true) {
		System.out.println("A Mountain Bike esta andando!!");
	}else {
		System.out.println("A Mountain Bike esta parada");
	}
	}
